...
// If Zip is in range: Delivery Available
    if (deliveryAreaZipCodes.includes(zipCode)) {
      return console.log("You're in our delivery zone!")
// If Zip is NOT in range: Delivery Unavailable
    } else {
...
// For Loop to check through every Zip in the Delivery Area
...
//CODE HERE
//The first title in the Variable is 'deals[0].title'
//The Replace Method replaces the 15 with a 10
//The replace method replaces the first item in the array with the second item
// In this case: title.replace('15', '10')
deals[0].title = deals[0].title.replace('15', '10')
console.log(deals[0].title)
//Running the second title in the variable
console.log(deals[1].title)
// Console.log to act a as separater in the Console
// Just for visual purposes
console.log(" ")
...
//CODE HERE
//Replacing March with April
deals[1].desc = deals[1].desc.replace('March', 'April')
//Running the first title in the variable
console.log(deals[0].desc)
//Running the second title in the variable
//Removing White space first
let newDealsDesc = deals[1].desc.trim()
console.log(newDealsDesc)
//Console.log to act a as separater in the Console
console.log(" ")
