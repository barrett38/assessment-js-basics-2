...
//CODE HERE
const empOne = new Employee(`Bill`, `Only on Tuesday's when the moon is in the 7th House and Mars aligns with Jupiter`);
...
//CODE HERE
const manager = new Manager(`Dwight`, `24/7/365`, ['Jim', 'Pam', 'Ryan', 'Toby']);
